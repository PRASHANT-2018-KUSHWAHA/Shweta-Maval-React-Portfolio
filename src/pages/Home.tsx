...
const images = [
  "https://ais-pre-22sk7euhleka435rpr2u6b-142698724020.asia-southeast1.run.app/input_file_0.png",
  "https://ais-pre-22sk7euhleka435rpr2u6b-142698724020.asia-southeast1.run.app/input_file_1.png",
  "https://ais-pre-22sk7euhleka435rpr2u6b-142698724020.asia-southeast1.run.app/input_file_2.png"
];
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                className="group relative flex items-center gap-6 px-10 py-4 rounded-full border border-brand-ink/10 hover:border-brand-coral transition-all duration-700 overflow-hidden"
              >
                ...
                <span className="relative z-10 text-xs uppercase tracking-[0.4em] font-bold group-hover:text-white transition-colors">Enter Experience</span>
            ...
            <motion.div 
              ...
              transition={{ 
                x: { duration: 1.5, ease: [0.22, 1, 0.36, 1], delay: shouldSlide ? 0 : 0.5 },
              ...
              <AnimatePresence mode="popLayout">
                <motion.img 
                  ...
                  initial={{ 
                    ...
                    scale: 0.95, 
                    y: 20, 
                    filter: "blur(10px) drop-shadow(0 20px 30px rgba(0,0,0,0.5))" 
                  }}
                  animate={{ 
                    opacity: 1, 
                    scale: [1, 1.05],
          ...
          >
            ...
            <div className="w-full md:w-[55%] h-full relative overflow-hidden flex items-end justify-center">
                ...
                <AnimatePresence mode="popLayout">
                  <motion.img 
                    ...
                    initial={{ 
                      ...
                      x: 50, 
                      scale: 1.1, 
                      filter: "blur(10px) drop-shadow(0 30px 40px rgba(0,0,0,0.3))" 
                    }}
                    animate={{ 
                      opacity: 1, 
                      x: 0,
                      scale: [1.1, 1.2],
                      filter: "blur(0px) drop-shadow(0 30px 40px rgba(0,0,0,0.3))"
                    }}
                    exit={{ 
                      opacity: 0, 
                      x: -50, 
              ...
              <div className="absolute top-1/2 left-10 -translate-y-1/2 z-0 pointer-events-none">
                <span className="text-[30vw] font-bold text-white/5 leading-none select-none font-headline">EG</span>
              </div>
            </div>
              ...
              <div className="max-w-xl">
                ...
                >
                  ...
                  <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-brand-ink leading-[0.8] mb-12 font-headline">
                    Game-<br /> 
                    <span className="serif-italic font-normal italic text-brand-coral">Changer</span>
                  </h1>
                  
                  <p className="text-xl md:text-2xl text-brand-muted leading-relaxed mb-16 font-light max-w-md">
                    Actress, producer, writer, speaker, and advocate with a knack for introducing people to their A-game.
                  </p>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    >
                      <span className="uppercase tracking-[0.3em] text-sm font-bold">Public Speaking</span>
                    ...
                    <motion.button 
                      ...
                      className="group flex items-center justify-between w-full py-6 border-b border-brand-ink/10 text-brand-ink hover:text-brand-coral transition-all duration-500"
                    >
                      <span className="uppercase tracking-[0.3em] text-sm font-bold">Consulting</span>
                      <div className="w-12 h-12 rounded-full border border-brand-ink/10 flex items-center justify-center group-hover:bg-brand-coral group-hover:border-brand-coral group-hover:text-white transition-all">
                        <ArrowRight size={20} />
                      </div>
                    </motion.button>
